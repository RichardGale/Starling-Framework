...
namespace display {
     ...
     * 
     * */        Stage: public DisplayObjectContainer{private:  int mWidth;
        private:  int mHeight;
        private:  unsigned int mColor;
        private:  EnterFrameEvent* mEnterFrameEvent;

        /** @private */
        public:          Stage(int width, int height, unsigned int color=0);
        ...
        /** @private */
        public: virtual void         x(float value);

        /** @private */
        public: virtual void         y(float value);

        /** @private */
        public: virtual void         scaleX(float value);

        /** @private */
        public: virtual void         scaleY(float value);

        /** @private */
        public: virtual void         rotation(float value);
