...
namespace textures {
    class SubTexture: public Texture
    {
        ...
        /** Helper object. */
        private: static  Point* sTexCoords;
        ...
        public:          SubTexture(Texture* parentTexture, Rectangle* region,
        ...
        /** @inheritDoc */
        public: virtual void     adjustVertexData(VertexData* vertexData, int vertexID, int count);
