...
#include "starling/core/TouchProcessor.h"
...
namespace core {
        ...
        void Starling::onContextCreated(flash::events::Event* event)
        {
        ...
        void Starling::onEnterFrame(flash::events::Event* event)
        {
        ...
        void Starling::onMouseLeave(flash::events::Event* event)
        {
            mTouchProcessor->enqueueMouseLeftStage();
        }

        void Starling::onTouch(flash::events::Event* event)
        {
            if (!mStarted) return;
        ...
        {
            return dynamic_cast<Program3D*>(programs[name]);
        }
        ...
        {
            return dynamic_cast<std::map<std::string, void*>>(sContextData[mStage3D]);
        }
        ...
        starling::display::Stage* Starling::stage()
        {
            return mStage;
        }
