...
namespace tests
{
    ...
    void TextureTest::                testTextureCoordinates()
    {
        ...
        Helpers->comparePoints(newPoint(0.25, 0.25), texCoords);
        adjustedVertexData->getTexCoords(1,texCoords);
        Helpers->comparePoints(newPoint(0.75, 0.25), texCoords);
        adjustedVertexData->getTexCoords(2,texCoords);
        Helpers->comparePoints(newPoint(0.25, 0.75), texCoords);
        adjustedVertexData->getTexCoords(3,texCoords);
        Helpers->comparePoints(newPoint(0.75, 0.75), texCoords);
        ...
        adjustedVertexData->getTexCoords(0,texCoords);
        Helpers->comparePoints(newPoint(0.375, 0.375), texCoords);
        adjustedVertexData->getTexCoords(1,texCoords);
        Helpers->comparePoints(newPoint(0.625, 0.375), texCoords);
        adjustedVertexData->getTexCoords(2,texCoords);
        Helpers->comparePoints(newPoint(0.375, 0.625), texCoords);
        adjustedVertexData->getTexCoords(3,texCoords);
        Helpers->comparePoints(newPoint(0.625, 0.625), texCoords);
