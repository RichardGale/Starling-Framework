...
namespace events {
    class Event
    {
        ...
        public: static const std::string ADDED;
        /** Event type for a display object that is added to the stage */
        public: static const std::string ADDED_TO_STAGE;
        /** Event type for a display object that is entering a new frame. */
        public: static const std::string ENTER_FRAME;
        /** Event type for a display object that is removed from its parent. */
        public: static const std::string REMOVED;
        /** Event type for a display object that is removed from the stage. */
        public: static const std::string REMOVED_FROM_STAGE;
        /** Event type for a triggered button. */
        public: static const std::string TRIGGERED;
        /** Event type for a display object that is being flattened. */
        public: static const std::string FLATTEN;
        /** Event type for a resized Flash Player. */
        public: static const std::string RESIZE;
        /** Event type that may be used whenever something finishes. */
        public: static const std::string COMPLETE;
        /** Event type for a (re)created stage3D rendering context. */
        public: static const std::string CONTEXT3D_CREATE;
        /** Event type that indicates that the root DisplayObject has been created. */
        public: static const std::string ROOT_CREATED;
        /** Event type for an animated object that requests to be removed from the juggler. */
        public: static const std::string REMOVE_FROM_JUGGLER;

        /** An event type to be utilized in custom events. Not used by Starling right now. */
        public: static const std::string CHANGE;
        /** An event type to be utilized in custom events. Not used by Starling right now. */
        public: static const std::string CANCEL;
        /** An event type to be utilized in custom events. Not used by Starling right now. */
        public: static const std::string SCROLL;
        /** An event type to be utilized in custom events. Not used by Starling right now. */
        public: static const std::string OPEN;
        /** An event type to be utilized in custom events. Not used by Starling right now. */
        public: static const std::string CLOSE;
        /** An event type to be utilized in custom events. Not used by Starling right now. */
        public: static const std::string SELECT;

        private: static  std::vector<Event*>* sEventPool;

        private:  EventDispatcher* mTarget;
        private:  EventDispatcher* mCurrentTarget;
        private:  std::string mType;
        ...
        public:          Event(std::string type, bool bubbles   =false, Object* data=NULL);
