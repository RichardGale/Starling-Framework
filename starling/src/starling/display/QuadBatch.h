...
#include "Class.h"
#include "RegExp.h"
namespace com { namespace adobe { namespace utils { class AGALMiniAssembler; } } }
...
namespace flash { namespace geom { class Matrix3D; } }
...
namespace starling { namespace filters { class FragmentFilterMode; } }
...
namespace display {
    ...
    {
        private: static const std::string QUAD_PROGRAM_NAME;
        ...
        private: static  std::vector<float>* sRenderAlpha;
        private: static  Matrix3D* sRenderMatrix;
        private: static  std::map<std::string, void*> sProgramNameCache;
        ...
        public: QuadBatch* clone();

        private: void     expand(int newCapacity=-1);
         ...
         *  display list. */
        public: void     renderCustom(Matrix* mvpMatrix, float parentAlpha =1.0,
        ...
        public: void     addImage(Image* image, float parentAlpha =1.0, Matrix* modelViewMatrix=NULL,
                                 std::string blendMode=NULL);
         ...
         *  the batch. */
        public: void     addQuad(Quad* quad, float parentAlpha =1.0, Texture* texture=NULL,
        ...
        public: void     addQuadBatch(QuadBatch* quadBatch, float parentAlpha =1.0,
        ...
        public: bool     isStateChange(bool tinted, float parentAlpha, Texture* texture,
        ...
        public: static void compile(DisplayObject* object,
                                       std::vector<QuadBatch*>* quadBatches);

        private: static int compileObject(DisplayObject* object,
                                              std::vector<QuadBatch*>* quadBatches,
                                              int quadBatchID,
        ...
        private: static void registerPrograms();                              // use explicit string for compatibility

        private: static std::string getImageProgramName(bool tinted, bool mipMap   =true,
                                                    bool repeat   =false, std::string format="bgra",
                                                    std::string smoothing="bilinear");
    };
}
}
