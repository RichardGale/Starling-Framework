...
#include "Class.h"
#include "RegExp.h"
namespace flash { namespace display { class Sprite; } }
namespace flash { namespace display { class Stage3D; } }
namespace flash { namespace display { class StageAlign; } }
namespace flash { namespace display { class StageScaleMode; } }
namespace flash { namespace display3D { class Context3D; } }
namespace flash { namespace display3D { class Context3DCompareMode; } }
namespace flash { namespace display3D { class Context3DTriangleFace; } }
namespace flash { namespace display3D { class Program3D; } }
namespace flash { namespace errors { class IllegalOperationError; } }
namespace flash { namespace events { class ErrorEvent; } }
namespace flash { namespace events { class Event; } }
namespace flash { namespace events { class KeyboardEvent; } }
namespace flash { namespace events { class MouseEvent; } }
namespace flash { namespace events { class TouchEvent; } }
namespace flash { namespace geom { class Rectangle; } }
namespace flash { namespace system { class Capabilities; } }
namespace flash { namespace text { class TextField; } }
namespace flash { namespace text { class TextFieldAutoSize; } }
namespace flash { namespace text { class TextFormat; } }
namespace flash { namespace text { class TextFormatAlign; } }
namespace flash { namespace ui { class Mouse; } }
namespace flash { namespace ui { class Multitouch; } }
namespace flash { namespace ui { class MultitouchInputMode; } }
namespace flash { namespace utils { class ByteArray; } }
namespace flash { namespace utils { class Dictionary; } }
namespace flash { namespace utils { class getTimer; } }
namespace flash { namespace utils { class setTimeout; } }
...
namespace starling { namespace events { class ResizeEvent; } }
...
namespace core {
     ...
     * 
     */          Starling: public EventDispatcher{/** The version of the Starling framework. */public: static const std::string VERSION;

        /** The key for the shader programs stored in 'contextData' */
        private: static const std::string PROGRAM_DATA_NAME;

        // members

        private:  Stage3D* mStage3D;
        private:  Stage* mStage; // starling.display.stage!
        private:  Class* mRootClass;
        private:  DisplayObject* mRoot;
        private:  Juggler* mJuggler;
        private:  bool mStarted;
        private:  RenderSupport* mSupport;
        ...
        private:  StatsDisplay* mStatsDisplay;
        private:  bool mShareContext;
        private:  std::string mProfile;
        private:  bool mSupportHighResolutions;
        private:  Context3D* mContext;

        private:  Rectangle* mViewPort;
        private:  Rectangle* mPreviousViewPort;
        private:  Rectangle* mClippedViewPort;

        private:  flash::display::Stage* mNativeStage;
        private:  flash::display::Sprite* mNativeOverlay;
        private:  float mNativeStageContentScaleFactor;

        private: static  Starling* sCurrent;
        private: static  bool sHandleLostContext;
        private: static  std::map<std::string, void*> sContextData;
         ...
         */
        public:          Starling(Class* rootClass, flash::display::Stage* stage,
        ...
        private: void     showFatalError(std::string message);
        ...
        private: void     onStage3DError(ErrorEvent* event);
        ...
        private: void     onTouch(Event* event);

        private: std::vector<void*> touchEventTypes();
         ...
         *  context loss. */
        public: std::map<std::string, void*> contextData();
        ...
        public: void         enableErrorChecking(bool value);
        ...
        public: void         viewPort(Rectangle* value);
        ...
        public: void     showStatsAt(std::string hAlign="left", std::string vAlign="top", float scale =1);
        ...
        public: flash::display::Stage* nativeStage();
        ...
        public: void         shareContext(bool value);
        ...
        public: bool         supportHighResolutions();
        public: void         supportHighResolutions(bool value);
        ...
        public: static Context3D* context();
        ...
        public: static void  multitouchEnabled(bool value);
        ...
        public: static bool  handleLostContext();
        public: static void  handleLostContext(bool value);
    };
}
}
