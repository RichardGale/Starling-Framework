...
#include "Class.h"
#include "RegExp.h"
namespace flash { namespace ui { class Keyboard; } }
...
using namespace utils;
    ...
    class Game: public Sprite
    {
        ...
        private: static const ////[Embed(source="../../demo/assets/fonts/Ubuntu-R.ttf",embedAsCFF="false",fontFamily="Ubuntu")]Class* UbuntuRegular;
        ...
        private: void     onButtonTriggered(Event* event);

        private: void     closeScene();

        private: void     showScene(std::string name);
