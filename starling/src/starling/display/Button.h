...
namespace display {
     ...
     */          Button: public DisplayObjectContainer{private: static const float MAX_DRAG_DIST;

        private:  Texture* mUpState;
        private:  Texture* mDownState;
        ...
        public:          Button(Texture* upState, std::string text="", Texture* downState=NULL);
        ...
        public: void         scaleWhenDown(float value);

        /** The alpha value of the button when it is disabled. @default 0.5 */
        public: float        alphaWhenDisabled();
        public: void         alphaWhenDisabled(float value);
        ...
        public: unsigned int fontColor();
        public: void         fontColor(unsigned int value);
        ...
        public: void         upState(Texture* value);

        /** The texture that is displayed while the button is touched. */
        public: Texture*     downState();
        public: void         downState(Texture* value);

        /** The vertical alignment of the text on the button. */
        public: std::string  textVAlign();
        public: void         textVAlign(std::string value);

        /** The horizontal alignment of the text on the button. */
        public: std::string  textHAlign();
        public: void         textHAlign(std::string value);
        ...
        public: virtual void         useHandCursor(bool value);
    };
}
}
