...
namespace animation {
    class Transitions
    {
        public: static const std::string LINEAR;
        public: static const std::string EASE_IN;
        public: static const std::string EASE_OUT;
        public: static const std::string EASE_IN_OUT;
        public: static const std::string EASE_OUT_IN;
        public: static const std::string EASE_IN_BACK;
        public: static const std::string EASE_OUT_BACK;
        public: static const std::string EASE_IN_OUT_BACK;
        public: static const std::string EASE_OUT_IN_BACK;
        public: static const std::string EASE_IN_ELASTIC;
        public: static const std::string EASE_OUT_ELASTIC;
        public: static const std::string EASE_IN_OUT_ELASTIC;
        public: static const std::string EASE_OUT_IN_ELASTIC;
        public: static const std::string EASE_IN_BOUNCE;
        public: static const std::string EASE_OUT_BOUNCE;
        public: static const std::string EASE_IN_OUT_BOUNCE;
        public: static const std::string EASE_OUT_IN_BOUNCE;

        private: static  std::map<std::string, void*> sTransitions;

        /** @private */
        public:          Transitions();

        /** Returns the transition function that was registered under a certain name. */
        public: static Function* getTransition(std::string name);

        /** Registers a new transition function under a certain name. */
        public: static void REGISTER(std::string name, Function* func);
        ...
        protected: static float easeCombined(Function* startFunc, Function* endFunc, float ratio);
    };
}
}
