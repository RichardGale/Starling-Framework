...
namespace starling
{
    namespace display
    {
        class MovieClip: public Image, public IAnimatable
        {
        private:
        ...
        public:
            MovieClip(std::vector<Texture *> *textures, float fps);
        ...
        public:
            void     addFrame(Texture *texture, Sound *sound, float duration);

            /** Adds a frame at a certain index, optionally with a sound and a custom duration. */
        public:
            void     addFrameAt(int frameID, Texture *texture, Sound *sound,
                                float duration);
        ...
        public:
            void     setFrameTexture(int frameID, Texture *texture);
        ...
        public:
             ...
             *  is displayed. */
        public:
            void     setFrameSound(int frameID, Sound *sound);
