...
namespace starling
{
    namespace textures
    {
        ...
        /** Helper object. */
        Point *SubTexture::sTexCoords=newPoint();
        ...
        void SubTexture::setClipping(Rectangle *value)
        {
            ...
            SubTexture *parentTexture=static_cast<SubTexture>(mParent);
            while (parentTexture)
            {
                ...
                parentTexture = parentTexture->static_cast<SubTexture>(mParent);
            }
        }
         ...
         *  scaled into [0.0, 1.0]. */
        Rectangle *SubTexture::clipping()
        {
            return mClipping->clone();
        }

        /** @inheritDoc */
        TextureBase *SubTexture::base()
        {
            return mParent->base;
        }

        /** @inheritDoc */
        ConcreteTexture *SubTexture::root()
        {
            return mParent->root;
        }

        /** @inheritDoc */
        std::string SubTexture::format()
        {
