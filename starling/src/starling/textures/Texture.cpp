...
namespace starling
{
    namespace textures
    {
        ...
        /** helper object */
        Point *Texture::sOrigin=newPoint();
        ...
        float Texture::nativeWidth()
        {
            return 0;
        }

        /** The height of the texture in pixels (without scale adjustment). */
        float Texture::nativeHeight()
        {
            return 0;
        }
        ...
        bool Texture::mipMapping()
        {
            return false;
        }

        /** Indicates if the alpha values are premultiplied into the RGB values. */
        bool Texture::premultipliedAlpha()
        {
            return false;
        }
    }
