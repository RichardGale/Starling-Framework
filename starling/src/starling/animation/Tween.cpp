...
namespace animation {
        ...
        Object* Tween::target()        { return mTarget; }

        /** The transition method used for the animation. @see Transitions */
        std::string Tween::transition()        { return mTransitionName; }
        ...
        Function* Tween::transitionFunc()          { return mTransitionFunc; }
        ...
        int Tween::repeatCount()     { return mRepeatCount; }
        void Tween::repeatCount(int value)      { mRepeatCount = value; }

        /** The amount of time to wait between repeat cycles, in seconds. @default 0 */
        float Tween::repeatDelay()        { return mRepeatDelay; }
        void Tween::repeatDelay(float value)      { mRepeatDelay = value; }
        ...
        bool Tween::reverse()         { return mReverse; }
        void Tween::reverse(bool value)      { mReverse = value; }

        /** Indicates if the numeric values should be cast to Integers. @default false */
        bool Tween::roundToInt()         { return mRoundToInt; }
        void Tween::roundToInt(bool value)      { mRoundToInt = value; }

        /** A function that will be called when the tween starts (after a possible delay). */
        Function* Tween::onStart()          { return mOnStart; }
        void Tween::onStart(Function* value)      { mOnStart = value; }

        /** A function that will be called each time the tween is advanced. */
        Function* Tween::onUpdate()          { return mOnUpdate; }
        void Tween::onUpdate(Function* value)      { mOnUpdate = value; }

        /** A function that will be called each time the tween finishes one repetition
         *  (except the last, which will trigger 'onComplete'). */
        Function* Tween::onRepeat()          { return mOnRepeat; }
        void Tween::onRepeat(Function* value)      { mOnRepeat = value; }

        /** A function that will be called when the tween is complete. */
        Function* Tween::onComplete()          { return mOnComplete; }
        void Tween::onComplete(Function* value)      { mOnComplete = value; }

        /** The arguments that will be passed to the 'onStart' function. */
        std::vector<void*> Tween::onStartArgs()       { return mOnStartArgs; }
        void Tween::onStartArgs(std::vector<void*> value)      { mOnStartArgs = value; }

        /** The arguments that will be passed to the 'onUpdate' function. */
        std::vector<void*> Tween::onUpdateArgs()       { return mOnUpdateArgs; }
        void Tween::onUpdateArgs(std::vector<void*> value)      { mOnUpdateArgs = value; }

        /** The arguments that will be passed to the 'onRepeat' function. */
        std::vector<void*> Tween::onRepeatArgs()       { return mOnRepeatArgs; }
        void Tween::onRepeatArgs(std::vector<void*> value)      { mOnRepeatArgs = value; }

        /** The arguments that will be passed to the 'onComplete' function. */
        std::vector<void*> Tween::onCompleteArgs()       { return mOnCompleteArgs; }
        void Tween::onCompleteArgs(std::vector<void*> value)      { mOnCompleteArgs = value; }

        /** Another tween that will be started (i.e. added to the same juggler) as soon as 
         *  this tween is completed. */
        Tween* Tween::nextTween()       { return mNextTween; }
        void Tween::nextTween(Tween* value)      { mNextTween = value; }
        ...
        Tween* Tween::fromPool(Object* target, float time,
                                                   Object* transition)
        {
            if (sTweenPool.size()) return sTweenPool.pop()->reset(target, time, transition);
