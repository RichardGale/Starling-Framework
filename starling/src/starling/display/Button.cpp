...
namespace starling
{
    namespace display
    {
        ...
        /** The scale factor of the button on touch. Per default, a button with a down state
          * texture won't scale. */
        float Button::scaleWhenDown()
        {
            return mScaleWhenDown;
        }
        void Button::scaleWhenDown(float value)
        {
            mScaleWhenDown = value;
        }

        /** The alpha value of the button when it is disabled. @default 0.5 */
        float Button::alphaWhenDisabled()
        {
            return mAlphaWhenDisabled;
        }
        void Button::alphaWhenDisabled(float value)
        {
         ...
         *  @default true */
        bool Button::useHandCursor()
        {
            return mUseHandCursor;
        }
        void Button::useHandCursor(bool value)
        {
