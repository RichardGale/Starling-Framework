...
namespace tests
{
    ...
    void DisplayObjectContainerTest::                testRemoveChildren()
    {
        ...
        Sprite *DisplayObjectContainerTest::(int numChildren)
        {
    ...
    void DisplayObjectContainerTest::                testBoundsInSpace()
    {
        ...
        void DisplayObjectContainerTest::(Sprite* sprite)
        {
            sprite->addChild(newQuad(100, 100));
        }
    }
    ...
    void DisplayObjectContainerTest::                testRemovedFromStage()
    {
        ...
        void DisplayObjectContainerTest::(Event* e)
        {
    ...
    void DisplayObjectContainerTest::onAdded(Event *event)
    {
        mAdded++;
    }
    void DisplayObjectContainerTest::onAddedToStage(Event *event)
    {
        mAddedToStage++;
    }
    void DisplayObjectContainerTest::onAddedChild(Event *event)
    {
        mAddedChild++;
    }

    void DisplayObjectContainerTest::onRemoved(Event *event)
    {
        mRemoved++;
    }
    void DisplayObjectContainerTest::onRemovedFromStage(Event *event)
    {
        mRemovedFromStage++;
    }
    void DisplayObjectContainerTest::onRemovedChild(Event *event)
    {
        mRemovedChild++;
    }
}
