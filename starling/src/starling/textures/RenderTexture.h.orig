...
namespace textures {
    class RenderTexture: public SubTexture
    {
        ...
        public:          RenderTexture(int width, int height, bool persistent   =true, float scale =-1);
         ...
         */
        public: void     draw(DisplayObject* object, Matrix* matrix=NULL, float alpha =1.0,
                             int antiAliasing=0);
        ...
        public: void     drawBundled(Function* drawingBlock, int antiAliasing=0);
