...
namespace starling
{
    namespace core
    {
        class Starling: public EventDispatcher
        {
        ...
        private:
            static std::map<void *, void *> sContextData;
        ...
        public:
            void     showStatsAt(std::string hAlign, std::string vAlign, float scale);
