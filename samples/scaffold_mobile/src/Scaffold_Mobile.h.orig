...
#include "Class.h"
#include "RegExp.h"
namespace flash { namespace desktop { class NativeApplication; } }
namespace flash { namespace display { class Bitmap; } }
#include "flash/display/Sprite.h"
namespace flash { namespace events { class Event; } }
namespace flash { namespace filesystem { class File; } }
...
using namespace starling::utils;
    ...
    class Scaffold_Mobile: public Sprite
    {
        ...
        private: static const ////[Embed(source="/fonts/Ubuntu-R.ttf",embedAsCFF="false",fontFamily="Ubuntu")]Class* UbuntuRegular;

        // Startup image for SD screens

        private: static  ////[Embed(source="/startup.jpg")]Class* Background;

        // Startup image for HD screens

        private: static  ////[Embed(source="/startupHD.jpg")]Class* BackgroundHD;

        private:  Starling* mStarling;

        public:          Scaffold_Mobile();
    };
