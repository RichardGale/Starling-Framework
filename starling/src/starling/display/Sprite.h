...
namespace display {
     ...
     */          Sprite: public DisplayObjectContainer{private:  std::vector<QuadBatch*>* mFlattenedContents;
        ...
        public: void         clipRect(Rectangle* value);
        ...
        public: Rectangle* getClipRect(DisplayObject* targetSpace, Rectangle* resultRect=NULL);
