...
namespace flash { namespace ui { class MouseCursor; } }
...
namespace starling { namespace errors { class AbstractMethodError; } }
...
namespace display {
     ...
     */          DisplayObject: public EventDispatcher{// membersprivate:  float mX;
        ...
        private:  DisplayObjectContainer* mParent;
        private:  Matrix* mTransformationMatrix;
        private:  bool mOrientationChanged;
        private:  FragmentFilter* mFilter;

        /** Helper objects. */
        private: static  std::vector<DisplayObject*>* sAncestors;
        private: static  Rectangle* sHelperRect;
        ...
        public: Rectangle* getBounds(DisplayObject* targetSpace, Rectangle* resultRect=NULL);
         ...
         *  the test to fail. */
        public: DisplayObject* hitTest(Point* localPoint, bool forTouch   =false);

        /** Transforms a point from the local coordinate system to global (stage) coordinates.
         *  If you pass a 'resultPoint', the result will be stored in this point instead of 
         *  creating a new object. */
        public: Point*   localToGlobal(Point* localPoint, Point* resultPoint=NULL);

        /** Transforms a point from global (stage) coordinates to the local coordinate system.
         *  If you pass a 'resultPoint', the result will be stored in this point instead of 
         *  creating a new object. */
        public: Point*   globalToLocal(Point* globalPoint, Point* resultPoint=NULL);
        ...
        public: void     render(RenderSupport* support, float parentAlpha);
        ...
        // helpers
                ...
                private: bool isEquivalent(float a, float b, float epsilon =0.0001);
        ...
        public: void         transformationMatrix(Matrix* matrix);

        /** Indicates if the mouse cursor should transform into a hand while it's over the sprite. 
         *  @default false */
        public: bool         useHandCursor();
        public: void         useHandCursor(bool value);
        ...
        public: float        skewX();
        public: void         skewX(float value);

        /** The vertical skew angle in radians. */
        public: float        skewY();
        public: void         skewY(float value);
        ...
        public: void         touchable(bool value);
        ...
        public: void         name(std::string value);
        ...
        public: void         filter(FragmentFilter* value);
