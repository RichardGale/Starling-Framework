...
namespace starling
{
    namespace core
    {
         ...
         *
         */
        class Starling : public starling::events::EventDispatcher
        {
        ...
        private:
            Stage3D *mStage3D;
        private:
            starling::display::Stage *mStage; // starling.display.stage!
        private:
            Class *mRootClass;
        private:
            DisplayObject *mRoot;
        ...
        private:
            void     onContextCreated(flash::events::Event *event);

        private:
            void     onEnterFrame(flash::events::Event *event);

        private:
            void     onKey(KeyboardEvent *event);

        private:
            void     onResize(flash::events::Event *event);

        private:
            void     onMouseLeave(flash::events::Event *event);
