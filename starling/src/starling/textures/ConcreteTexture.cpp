...
namespace starling
{
    namespace textures
    {
        ...
        bool ConcreteTexture::optimizedForRenderTexture()
        {
            return mOptimizedForRenderTexture;
        }

        /** @inheritDoc */
        TextureBase *ConcreteTexture::base()
        {
            return mBase;
        }

        /** @inheritDoc */
        ConcreteTexture *ConcreteTexture::root()
        {
            return this;
        }

        /** @inheritDoc */
        std::string ConcreteTexture::format()
        {
            return mFormat;
        }

        /** @inheritDoc */
        float ConcreteTexture::width()
        {
            return mWidth / mScale;
        }

        /** @inheritDoc */
        float ConcreteTexture::height()
        {
            return mHeight / mScale;
        }

        /** @inheritDoc */
        float ConcreteTexture::nativeWidth()
        {
            return mWidth;
        }

        /** @inheritDoc */
        float ConcreteTexture::nativeHeight()
        {
            return mHeight;
        }

        /** The scale factor, which influences width and height properties. */
        float ConcreteTexture::scale()
        {
            return mScale;
        }

        /** @inheritDoc */
        bool ConcreteTexture::mipMapping()
        {
            return mMipMapping;
        }

        /** @inheritDoc */
        bool ConcreteTexture::premultipliedAlpha()
        {
