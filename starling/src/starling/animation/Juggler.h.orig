...
namespace animation {
    ...
    {
        private:  std::vector<IAnimatable*>* mObjects;
        ...
        public: void     add(IAnimatable* object);

        /** Determines if an object has been added to the juggler. */
        public: bool     contains(IAnimatable* object);

        /** Removes an object from the juggler. */
        public: void     remove(IAnimatable* object);
        ...
        public: DelayedCall* delayCall(Function* call, float delay, ...);
         ...
         *  </pre> 
         */
        public: void     tween(Object* target, float time, Object* properties);

        private: void     onPooledTweenComplete(Event* event);

        /** Advances all objects by a certain time (in seconds). */
        public: void     advanceTime(float time);    // there is a high probability that the "advanceTime" function modifies the list 
