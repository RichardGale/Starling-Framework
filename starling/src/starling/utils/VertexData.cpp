...
namespace utils {
        ...
        bool VertexData::premultipliedAlpha()         { return mPremultipliedAlpha; }

        /** The total number of vertices. */
        int VertexData::numVertices()     { return mNumVertices; }
        ...
        std::vector<float> VertexData::rawData()                 { return mRawData; }
}
}
