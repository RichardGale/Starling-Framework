...
namespace core {
    class RenderSupport
    {
        ...
        private:  Matrix3D* mMvpMatrix3D;
        private:  std::vector<Matrix*>* mMatrixStack;
        private:  int mMatrixStackSize;

        private:  int mDrawCount;
        private:  std::string mBlendMode;

        private:  Texture* mRenderTarget;
        private:  int mBackBufferWidth;
        private:  int mBackBufferHeight;

        private:  std::vector<Rectangle*>* mClipRectStack;
        private:  int mClipRectStackSize;

        private:  std::vector<QuadBatch*>* mQuadBatches;
        private:  int mCurrentQuadBatchID;

        /** helper objects */
        private: static  Point* sPoint;
        private: static  Rectangle* sRectangle;
        private: static  AGALMiniAssembler* sAssembler;
        ...
        public: void     setOrthographicProjection(float x, float y, float width, float height);
        ...
        public: void     transformMatrix(DisplayObject* object);
        ...
        public: static void transformMatrixForObject(Matrix* matrix, DisplayObject* object);
        ...
        public: void         projectionMatrix(Matrix* value);
        ...
        public: std::string  blendMode();
        public: void         blendMode(std::string value);
        ...
        public: void         renderTarget(Texture* target);
        ...
        public: void         backBufferWidth(int value);
        ...
        public: void         backBufferHeight(int value);
        ...
        public: void     batchQuad(Quad* quad, float parentAlpha,
        ...
        public: static void setBlendFactors(bool premultipliedAlpha, std::string blendMode="normal");

        /** Clears the render context with a certain color and alpha value. */
        public: static void clear(unsigned int rgb=0, float alpha =0.0);

        /** Clears the render context with a certain color and alpha value. */
        public: void     clear(unsigned int rgb=0, float alpha =0.0);
        ...
        public: static Program3D* assembleAgal(std::string vertexShader, std::string fragmentShader,
        ...
        public: void     raiseDrawCount(unsigned int value=1);
