...
namespace events {
     ...
     */          KeyboardEvent: public Event{/** Event type for a key that was released. */public: static const std::string KEY_UP;

        /** Event type for a key that was pressed. */
        public: static const std::string KEY_DOWN;

        private:  unsigned int mCharCode;
        private:  unsigned int mKeyCode;
        private:  unsigned int mKeyLocation;
        private:  bool mAltKey;
        private:  bool mCtrlKey;
        private:  bool mShiftKey;

        /** Creates a new KeyboardEvent. */
        public:          KeyboardEvent(std::string type, unsigned int charCode=0, unsigned int keyCode=0,
                                      unsigned int keyLocation=0, bool ctrlKey   =false,
                                      bool altKey   =false, bool shiftKey   =false);

        /** Contains the character code of the key. */
        public: unsigned int charCode();
        ...
        public: unsigned int keyLocation();
