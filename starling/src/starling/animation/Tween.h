...
namespace animation {
    class Tween: public EventDispatcher, public IAnimatable
    {
        ...
        private:  Function* mTransitionFunc;
        private:  std::string mTransitionName;

        private:  std::vector<std::string>* mProperties;
        private:  std::vector<float>* mStartValues;
        private:  std::vector<float>* mEndValues;

        private:  Function* mOnStart;
        private:  Function* mOnUpdate;
        private:  Function* mOnRepeat;
        private:  Function* mOnComplete;

        private:  std::vector<void*> mOnStartArgs;
        private:  std::vector<void*> mOnUpdateArgs;
        private:  std::vector<void*> mOnRepeatArgs;
        private:  std::vector<void*> mOnCompleteArgs;
        ...
        public:          Tween(Object* target, float time, Object* transition="linear");

        /** Resets the tween to its default values. Useful for pooling tweens. */
        public: Tween*   reset(Object* target, float time, Object* transition="linear");

        /** Animates the property of the target to a certain value. You can call this method multiple
         *  times on one tween. */
        public: void     animate(std::string property, float endValue);
        ...
        public: float    getEndValue(std::string property);
        ...
        public: std::string  transition();
        public: void         transition(std::string value);

        /** The actual transition function used for the animation. */
        public: Function*    transitionFunc();
        public: void         transitionFunc(Function* value);
        ...
        public: void         repeatDelay(float value);
        ...
        public: void         onRepeat(Function* value);

        /** A function that will be called when the tween is complete. */
        public: Function*    onComplete();
        public: void         onComplete(Function* value);

        /** The arguments that will be passed to the 'onStart' function. */
        public: std::vector<void*> onStartArgs();
        public: void         onStartArgs(std::vector<void*> value);

        /** The arguments that will be passed to the 'onUpdate' function. */
        public: std::vector<void*> onUpdateArgs();
        public: void         onUpdateArgs(std::vector<void*> value);

        /** The arguments that will be passed to the 'onRepeat' function. */
        public: std::vector<void*> onRepeatArgs();
        public: void         onRepeatArgs(std::vector<void*> value);

        /** The arguments that will be passed to the 'onComplete' function. */
        public: std::vector<void*> onCompleteArgs();
        public: void         onCompleteArgs(std::vector<void*> value);

        /** Another tween that will be started (i.e. added to the same juggler) as soon as 
         *  this tween is completed. */
        public: Tween*       nextTween();
        public: void         nextTween(Tween* value);

        // tween pooling

        private: static  std::vector<Tween*>* sTweenPool;
